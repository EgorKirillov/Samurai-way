...
const UsersPageContainer = () => {
  ...
  const toggleShowFriendsHandler = () => {
    alert('ckick')
  }
 
  useEffect(() => {
    
    dispatch(getUsersThunkCreator({page: currentUsersPage, count:countUsersPerPage} ))
    
  }, [dispatch,currentUsersPage,countUsersPerPage])
  
  return <div> </div>
  // <UsersPage currentUsersPage={currentUsersPage}
  //                   pagesArr={pages}
  ...
  //                   toggleShowFriends={toggleShowFriendsHandler}
  // />
}
