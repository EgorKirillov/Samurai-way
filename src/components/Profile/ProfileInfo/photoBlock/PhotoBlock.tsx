...
export const PhotoBlock = (props: PhotoBlockType) => {
  ...
  const lookingForAJobDescription = useAppSelector(
    state => state.profilePage.userProfile.lookingForAJobDescription
  )
    ...
    <div>
      <Row wrap={false}>
        <Col span={5} style={{ minWidth: '180px' }}>
          <div>
            <Image width={150} src={photoLarge || userphoto} />
        ...
        <Col span={14}>
          ...
          <div>
            Status: <ProfileStatusWithHooks isOwner={props.isOwner} />
          </div>
          <div>
