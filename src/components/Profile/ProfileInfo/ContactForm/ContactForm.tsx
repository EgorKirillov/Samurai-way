    ...
    <div className={s.contactFormContainer}>
      <form className={s.formContact} onSubmit={handleSubmit(onSubmit)}>
        ...
        <input
          ...
          defaultValue={props.contacts.github}
          {...register('github')}
        />
        ...
        <input
          className={s.formInput}
          defaultValue={props.contacts.facebook}
          {...register('facebook')}
        />
        ...
        <input
          className={s.formInput}
          defaultValue={props.contacts.twitter}
          {...register('twitter')}
        />
        ...
        <input
          className={s.formInput}
          defaultValue={props.contacts.website}
          {...register('website')}
        />
        ...
        <input
          className={s.formInput}
          defaultValue={props.contacts.instagram}
          {...register('instagram')}
        />
        ...
        <input
          className={s.formInput}
          defaultValue={props.contacts.youtube}
          {...register('youtube')}
        />
        ...
        <input
          className={s.formInput}
          defaultValue={props.contacts.mainLink}
          {...register('mainLink')}
        />
